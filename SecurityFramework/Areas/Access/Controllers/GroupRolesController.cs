...
namespace SecurityFramework.Areas.Access.Controllers
{
    ...
    public class GroupRolesController : Controller
    {
        ...
        {
            return View(_accessUtils.GetGroupRoles().ToList());
        }
        ...
        public ActionResult Details(Guid? id)
        {
            ...
            var role = _accessUtils.GetGroupRoles().SingleOrDefault(item => item.Id == id);
            if (role == null)
                return HttpNotFound();
            return View(role);
        }
        ...
        // POST: Access/GroupRoles/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,Sequence,Name,GroupId")] Role role)
        {
            ...
            ViewBag.GroupId = new SelectList(_accessUtils.GetGroups(), "Id", "Breadcrumb", role.GroupId);
            return View(role);
        }

        // GET: Access/GroupRoles/Edit/5
        ...
        // POST: Access/GroupRoles/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Sequence,Name,GroupId")] Role role)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: Access/GroupRoles/Delete/5
        ...
        // POST: Access/GroupRoles/Delete/5
        [HttpPost]
